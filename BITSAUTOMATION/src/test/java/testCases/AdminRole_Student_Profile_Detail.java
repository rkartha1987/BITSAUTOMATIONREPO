...
public class AdminRole_Student_Profile_Detail extends CommonFunctions{
	...
	@Test(priority = 0)
	public void StudentDataMenu() throws InterruptedException, IOException, Throwable
	{
		...
		captureScreen("StudentDataList.png");
	}
	@Test(priority = 1)
	...
	public void VerifyPersonalInfo() throws Throwable
	{
		...
		captureScreen("PersonalInfo.png");
	...
	//@Test(priority = 3)
	public void ViewBioData() throws InterruptedException, IOException, Throwable
	{
