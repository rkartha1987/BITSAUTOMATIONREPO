...
public class FacultyAllot_StatOrFacultyWiseAllot_TC extends CommonFunctions{
	...
	public void Selectdrpdwn(WebElement Bat,String sheetname, int row, int col) throws Throwable {
		...
		captureScreen("BatchSelection.png");
		extenttestCase.log(Status.INFO,"Selected the Batch name");
	}

	public void MultiSelectListdrpdwn(List<WebElement> station_drpdwn,String sheetname, int row, int col) throws Throwable {
		...
		for(WebElement a:ln) {
			...
			if (ele.equalsIgnoreCase(station_name)) {
				a.click();	
				captureScreen("StationSelection.png");
			}
		}
	}
