...
public class FacultyRole_ProblemBank_Add extends CommonFunctions{
	...
	public void ProblemBankMenu() throws Throwable
	{
		...
		ProblemBank_Add_Objects.PBMenu.click();
		Thread.sleep(2000);

		ProblemBank_Add_Objects.AddProblemClick.click();
		Thread.sleep(2000);

		captureScreen("AddProblemClick.png");
		
		ProblemBank_Add_Objects.Cancel.click();
		Thread.sleep(2000);
		captureScreen("CancelClick.png");

		ProblemBank_Add_Objects.Close.click();
		Thread.sleep(2000);
		captureScreen("CloseClick.png");
	...
	@Test(priority = 1)
	public void VerfiyGeneralInfo() throws InterruptedException, Throwable
	{
		extenttestCase.log(Status.INFO,"Verifying Mandatory Field Validation in General Info");
		captureScreen("VerifyGeneralInfo-Before.png");
		ProblemBank_Add_Objects.SaveNext.click();
		captureScreen("VerifyGeneralInfo-After.png");
		Thread.sleep(2000);
	...
	public void AddGeneralInfo() throws Throwable
	{
		...
		captureScreen("AddGeneralInfo-Before.png");
		ProblemBank_Add_Objects.SaveNext.click();
		captureScreen("AddGeneralInfo-After.png");
		Thread.sleep(2000);
	...
	public void AddTechSkill() throws Throwable
	{
		...
		Thread.sleep(2000);
		captureScreen("AddSkill.png");
		
		ProblemBank_Add_Objects.CancelSkill.click();
		Thread.sleep(2000);
		captureScreen("CancelSkill.png");
	...
	public void AddNewDomain() throws Throwable
	{
		...
		Thread.sleep(2000);
		captureScreen("AddDomain.png");

		ProblemBank_Add_Objects.CancelDomain.click();
		Thread.sleep(2000);
		captureScreen("CancelDomain.png");

		ProblemBank_Add_Objects.AddDomain.click();
		Thread.sleep(2000);
		captureScreen("AddDomain1.png");

		ProblemBank_Add_Objects.SubmitDomain.click();
		Thread.sleep(2000);
		captureScreen("SubmitDomain.png");
		...
		ProblemBank_Add_Objects.SubmitDomain.click();
		Thread.sleep(2000);
		captureScreen("SubmitDomain1.png");

		ProblemBank_Add_Objects.CancelDomain.click();
		Thread.sleep(2000);
		captureScreen("CancelDomain1.png");

		ProblemBank_Add_Objects.AddDomain.click();
		Thread.sleep(2000);
		captureScreen("AddDomain2.png");
		...
		Thread.sleep(2000);
		captureScreen("CheckPDomain.png");
		
		ProblemBank_Add_Objects.SearchPDomain.click();
		Thread.sleep(2000);
		captureScreen("SearchPDomain.png");
		...
		Thread.sleep(2000);
		captureScreen("CheckPD.png");

		ProblemBank_Add_Objects.SearchPD.click();
		Thread.sleep(2000);
		captureScreen("SearchPD.png");

		ProblemBank_Add_Objects.SelectPSD.click();
		Thread.sleep(2000);
		captureScreen("SelectPSD.png");
		...
		ProblemBank_Add_Objects.SaveNextSkill.click();
		Thread.sleep(2000);
		captureScreen("SaveNextSkill.png");
	...
	public void AddElectives() throws Throwable
	{
		...
		Thread.sleep(2000);
		captureScreen("Electives-AddCourse.png");
		...
		Thread.sleep(2000);
		captureScreen("Electives-DeleteCourse.png");

		ProblemBank_Add_Objects.CloseCourse.click();
		Thread.sleep(2000);
		captureScreen("Electives-DeleteCourse-Close.png");
		...
		Thread.sleep(2000);
		captureScreen("Electives-DeleteCourse-Okay.png");
		...
		captureScreen("SaveNextElectives-Before.png");
		ProblemBank_Add_Objects.SaveNextElectives.click();
		captureScreen("SaveNextElectives-After.png");
		Thread.sleep(2000);
	...
	public void AddFacility() throws Throwable
	{
		...
		ProblemBank_Add_Objects.BCountry.sendKeys(getExcelData("AddProblem", 20, 9));
		Thread.sleep(2000);
