	...
	//Function to get Selected Group Leader Name from Grid	
		...
		public void SelectGridDropdownValue(List<WebElement> sta_list, List<WebElement> ci_list,List<WebElement> Dept_list,
				String stat_ex, String city_ex,String Dept_ex){
			for(WebElement str:sta_list)
			{
				...
				try {
					...
					Selectdrpdwn(aa,"FacultyGroupLeaderData", 14, 1);
					break;
		...
		//	Selectdrpdwn(FacultyAllot_GroupLeader_Allotment_Objects.BatchYear, "FacultyGroupLeaderData" , 4, 1);
			Selectdrpdwn(FacultyAllot_GroupLeader_Allotment_Objects.PStypeSelect, "FacultyGroupLeaderData" , 7, 1);
			Selectdrpdwn(FacultyAllot_GroupLeader_Allotment_Objects.AllotPS1, "FacultyGroupLeaderData" , 11, 1);
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
