...
public class FacultyRole_ProblemBank_Edit extends CommonFunctions{
	...
	public void ProblemBankMenu() throws InterruptedException, IOException
	{
		...
		File destinationFile = new File("Problem_Bank_Add.png");
		FileHandler.copy(sourceFile, destinationFile);
		extenttestCase.addScreenCaptureFromPath("Problem_Bank_Add.png");
