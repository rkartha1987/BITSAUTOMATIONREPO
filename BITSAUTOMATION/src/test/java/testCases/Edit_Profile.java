...
public class Edit_Profile extends CommonFunctions{
	...
	public void validateNavigatetoProfile() throws Throwable
	{
		...
		captureScreen("Profile.png");Thread.sleep(5000);			
	...
	public void validateCancelBtn() throws Throwable
	{
		...
		captureScreen("cancelbuttonclick.png");Thread.sleep(5000);			
	...
	public void validateCloseBtnPopup() throws Throwable
	{
		...
		captureScreen("closebuttonclick.png");Thread.sleep(5000);			
	...
	public void validateOkayBtnPopup() throws Throwable
	{
		...
		Profile_Page_Objects.btnCancel.click();Thread.sleep(3000);			
		extenttestCase.log(Status.INFO, "Successfully opened pop up ");Thread.sleep(3000);	
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
		extenttestCase=extentReport.createTest("Click Okay button test");
		logger.info("Clicking Okay Button");		
		PageFactory.initElements(driver, Profile_Page_Objects.class);
		Profile_Page_Objects.btnOkay.click();
		captureScreen("okbuttonclick.png");Thread.sleep(3000);			
		extenttestCase.log(Status.PASS, "Successfully Closed pop up ");
	}
	@Test(priority=5)
	public void validateNavigatetoProfile1() throws Throwable
	{
		...
		logger.info("Navigating to Profile Page");		
		PageFactory.initElements(driver, Profile_Page_Objects.class);
		Profile_Page_Objects.mnuProfile.click();Thread.sleep(5000);			
		extenttestCase.log(Status.PASS, "Successfully navigated to Profile Page");
	}
	...
	public void validateSaveBtnWithoutChngs() throws Throwable
	{
		...
		captureScreen("saveclickwithoutchanges.png");Thread.sleep(5000);			
	...
	public void validateSaveBtnWithChngs() throws Throwable
	{
		...
		PageFactory.initElements(driver, Profile_Page_Objects.class);
		Profile_Page_Objects.fldFacultyName.clear();Thread.sleep(2000);

		Profile_Page_Objects.fldFacultyName.sendKeys(getExcelData("Login", 2, 3));Thread.sleep(2000);	

		Profile_Page_Objects.fldGender.sendKeys(getExcelData("Fields", 1, 0));Thread.sleep(2000);		

		Profile_Page_Objects.fldDept.sendKeys(getExcelData("Fields", 1, 1));Thread.sleep(2000);

		Profile_Page_Objects.fldAreaOfSpc.clear();Thread.sleep(2000);
		Profile_Page_Objects.fldAreaOfSpc.sendKeys(getExcelData("Fields", 1, 2));Thread.sleep(2000);

		Profile_Page_Objects.fldCampus.sendKeys(getExcelData("Fields", 1, 3));Thread.sleep(2000);

		Profile_Page_Objects.fldPrsnlEmail.clear();Thread.sleep(2000);
		Profile_Page_Objects.fldPrsnlEmail.sendKeys(getExcelData("Fields", 1,4));Thread.sleep(2000);	
		...
		Profile_Page_Objects.fldAddr2.clear();Thread.sleep(2000);
		Profile_Page_Objects.fldAddr2.sendKeys(getExcelData("Fields", 1,9));Thread.sleep(2000);			

		Profile_Page_Objects.fldCountry.sendKeys(getExcelData("Fields", 1,10));Thread.sleep(2000);

		Profile_Page_Objects.fldState.sendKeys(getExcelData("Fields", 1,11));Thread.sleep(2000);
	...
	public void validateChangeOffclEmailId() throws Throwable
	{
		...
		Profile_Page_Objects.fldOffclEmail.clear();Thread.sleep(5000);	

		Profile_Page_Objects.fldOffclEmail.sendKeys(getExcelData("Fields", 1, 4));Thread.sleep(5000);	

		Profile_Page_Objects.btnSave.click();Thread.sleep(3500);	
		captureScreen("offcialemailedit.png");
		...
		Profile_Page_Objects.fldOffclEmail.sendKeys(getExcelData("Fields", 1, 5));Thread.sleep(5000);	
		Profile_Page_Objects.btnSave.click();Thread.sleep(5000);	
		captureScreen("offcialemailedit1.png");
	...
	public void validateRemoveGroupLeader() throws Throwable
	{
		...
		if (Profile_Page_Objects.fldGrpLeader.isSelected())
		{
			...
			Profile_Page_Objects.btnSave.click();
			captureScreen("RemoveGroupLeader.png");Thread.sleep(3000);	
	...
	public void validateAssignGroupLeader() throws Throwable
	{
		...
		{		
			...
			Profile_Page_Objects.fldGrpLeader.click();Thread.sleep(5000);					
			Profile_Page_Objects.btnSave.click();
			captureScreen("AssignGroupLeader.png");Thread.sleep(3000);	
			String text=driver.findElement(By.cssSelector(".toast-message")).getText().toString();
	...
	public void validateGroupLeaderFail() throws Throwable
	{
		...
		if (Profile_Page_Objects.fldGrpLeader.isSelected())
		{
			Profile_Page_Objects.fldGrpLeader.click();Thread.sleep(3000);
		}
		Profile_Page_Objects.fldDept.sendKeys(getExcelData("Fields",2, 1));Thread.sleep(3000);
	...
	{		
		...
		Profile_Page_Objects.fldAddr1.clear(); Thread.sleep(2000); 
		Profile_Page_Objects.fldPin.clear();Thread.sleep(2000);
		Profile_Page_Objects.fldDept.sendKeys(getExcelData("Fields",1, 1));Thread.sleep(3000);		 		 
		Profile_Page_Objects.btnSave.click();
		captureScreen("MandatoryFieldValidated.png");
		extenttestCase.log(Status.PASS, "Succesfully Saved");
		closeProfilepage();
	}
	...
	{
		PageFactory.initElements(driver, Profile_Page_Objects.class);
		Profile_Page_Objects.btnCancel.click();Thread.sleep(2000);
		Profile_Page_Objects.btnOkay.click();
	}
}