...
public class AdminRole_ManageFaculty_Detail extends CommonFunctions{
	
	static Logger logger = Logger.getLogger(AdminRole_ManageFaculty_Detail.class);
	
	@Test(priority = 0)
	public void ClickAddMFaculty() throws InterruptedException, IOException,Throwable
	{
		...
		CommonFunctions.captureScreen("ManageFacultyDetail.png");
	}
	
	@Test(priority = 1)
	public void AddMFacultyValidation() throws InterruptedException,Throwable
	{
	...
	public void AddNewFaculty() throws Throwable
	{
		...
		ManageFaculty_Detail_Page_Objects.AreaSpclzn.sendKeys(getExcelData("MFacultyDetail", 1, 17));
		Thread.sleep(2000);
		...
		ManageFaculty_Detail_Page_Objects.AddCountry.sendKeys(getExcelData("MFacultyDetail",3, 12));
		Thread.sleep(2000);
	...
	public void VerifyNewFacultyList() throws Throwable
	{
		...
		{
			extenttestCase.log(Status.FAIL, "New Faculty Addition Failed");
		}
	}
	...
	public void VerifyEditFacultyList() throws Throwable
	{
		...
		{
			extenttestCase.log(Status.FAIL, "Faculty Edition Failed");
		}
